...
export default function Workshop(props) {
    ...
    return (
        ...
        <group {...props} dispose={null} scale={0.125} position={[0.22, -0.75, 0]}>
            ...
            <group name="base">
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.level2base.geometry} position={[0, 9.996, -14.306]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.level2guards.geometry} position={[18.296, 11.962, -12.788]} rotation={[0, 0, -Math.PI / 2]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.wall1.geometry} position={[0.009, 0, 0]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.wall2.geometry} position={[0.175, 0, 4.406]} rotation={[0, -1.571, 0]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.floor.geometry} position={[0, 0.075, 0]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.b1.geometry} position={[19.625, 1.168, -12.648]} > <meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.b2.geometry} position={[19.625, 3.038, -12.675]} ><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.b3.geometry} position={[19.625, 0.796, -10.464]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.b4.geometry} position={[19.625, 2.562, -10.511]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* @ts-ignore */}
                <mesh geometry={baseNodes.b5.geometry} position={[17.843, 0.739, -11.668]}><meshBasicMaterial map={bakedTexture} /></mesh>
            </group>

            {/* @ts-ignore */}
            {/* <mesh name="fan" ref={meshRef} geometry={nodes.fan.geometry} position={[-15.235, 15.807, -16.066]} rotation={[Math.PI / 2, 0, 0]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            ...
            {/* @ts-ignore */}
            {/* {/* {/* <mesh name="miniRobo5" geometry={miniRobotF} position={[7.072, 9.868, -1.763]} rotation={[-3.141, 0.883, -0.001]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* </Float> */}

            {/* @ts-ignore */}
            {/* {/* <Float speed={6} floatIntensity={0.05} rotationIntensity={0.05}> */}
            {/* @ts-ignore */}
            {/* {/* {/* <mesh name="miniRobo6" geometry={miniRobotF} position={[-4.555, 4.292, 9.479]} rotation={[-0.001, 1.033, -3.141]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* </Float> */}

            {/* @ts-ignore */}
            {/* {/* <Float speed={6} floatIntensity={0.05} rotationIntensity={0.05}> */}
            {/* @ts-ignore */}
            {/* {/* {/* <mesh name="miniRobo7" geometry={miniRobotF} position={[-9.392, 10.257, -3.745]} rotation={[-3.141, -0.937, 0.001]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* </Float> */}
            {/* @ts-ignore */}
            {/*  <Float speed={6} floatIntensity={0.01} rotationIntensity={0.1}> */}
            {/* @ts-ignore */}
            {/* {/* {/* <mesh name="miniRobo8" geometry={miniRobotF} position={[14.216, 1.826, 6.173]} rotation={[-3.138, 1.373, -0.003]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* </Float> */}
            ...
            {/* @ts-ignore */}
            {/* <mesh name="miniRobo1" geometry={miniRobot} position={[-15.14, 0.684, -2.876]} rotation={[-2.99, -0.031, -0.008]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/* <mesh name="miniRobo2" geometry={miniRobot} position={[-13.623, 8.133, -0.04]} rotation={[-3.14, 1.12, -0.001]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/* <mesh name="miniRobo3" geometry={miniRobot} position={[-19.426, 0.684, 7.966]} rotation={[-1.072, -1.398, 2.064]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/* <mesh name="miniRobo4" geometry={miniRobot} position={[1.379, 2.1, 9.199]} rotation={[-0.912, -1.394, 2.222]}><meshBasicMaterial map={bakedTexture} /></mesh> */}

            {/* </group> */}
            {/* @ts-ignore */}
            {/*  <mesh name="legS" geometry={nodes.leg2.geometry} position={[-6.811, 0.167, 8.372]} rotation={[0.03, -0.79, -1.507]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/*  <mesh name="legB" geometry={nodes.leg1.geometry} position={[10.013, 1.59, 7.526]} rotation={[-1.548, -0.071, -2.986]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/* <group> */}
            {/* @ts-ignore */}
            {/*  <mesh name="fanB" geometry={nodes.fanB.geometry} position={[-15.235, 15.807, -16.066]} rotation={[Math.PI / 2, 0, 0]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/* <mesh name="fan" ref={meshRef} geometry={nodes.fan.geometry} position={[-15.235, 15.807, -16.066]} rotation={[Math.PI / 2, 0, 0]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            ...
            {/* <group> */}
            {/* @ts-ignore */}
            {/*  <mesh name="bigRobotBody" geometry={nodes.bigRobotBody.geometry} position={[0, 0.156, 0]}><meshMatcapMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/*  <mesh name="bigRobotarmL" geometry={nodes.bigRobotarmL.geometry} position={[12.831, 9.118, 0]}><meshBasicMaterial map={bakedTexture} /></mesh> */}

            {/* </group> */}
            {/* @ts-ignore */}
            {/* <group > */}
            {/* @ts-ignore */}
            {/* <mesh name="armR" geometry={nodes.armR.geometry} position={[-8.142, 9.081, -1.985]} rotation={[Math.PI, -0.474, 2.577]}><meshBasicMaterial map={bakedTexture} /></mesh> */}

            {/* @ts-ignore */}
            {/* <mesh name="chain-1" geometry={nodes["chain-1"].geometry} position={[-14.293, 7.534, 1.218]}><meshBasicMaterial map={bakedTexture} /></mesh> */}

            {/* @ts-ignore */}
            {/* <mesh name="chain-2" geometry={nodes["chain-2"].geometry} position={[-9.613, 9.067, -1.341]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* </group> */}
            {/* @ts-ignore */}
            {/* <group> */}
            {/* @ts-ignore */}
            {/* <mesh name="aircondition" geometry={nodes.aircondition.geometry} position={[-20.144, 7.402, 8.587]} rotation={[Math.PI / 2, 0, -Math.PI / 2]}><meshBasicMaterial map={bakedTexture} /></mesh> */}

            {/* @ts-ignore */}
            {/* <mesh name="aircondition" geometry={nodes.aircondition.geometry} position={[16.288, 7.402, -15.766]} rotation={[Math.PI / 2, 0, 0]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* </group> */}
            {/* @ts-ignore */}
            {/* <group name='door-1' > */}
            {/* name="d1" geometry={nodes.d1.geometry} position={[-20.515, 1.162, 12.905]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} */}
            {/* @ts-ignore */}
            {/* <mesh name="d2" geometry={nodes.d2.geometry} position={[-20.624, 0.158, 13.917]} rotation={[Math.PI / 2, 0, -Math.PI / 2]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
            {/* <mesh name="d3" geometry={nodes.d3.geometry} position={[-20.492, 1.683, 13.623]} rotation={[Math.PI / 2, 0, -Math.PI / 2]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* </group> */}
            {/* @ts-ignore */}
            {/* <group name='door-2'> */}
            {/* name="d4" geometry={nodes.d1.geometry} position={[16.821, 11.013, -16.11]} rotation={[Math.PI / 2, 0, 0]} */}
            {/* @ts-ignore */}
            {/* <mesh name="d6" geometry={nodes.d3.geometry} position={[16.102, 11.535, -16.088]} rotation={[Math.PI / 2, 0, 0]}><meshBasicMaterial map={bakedTexture} /></mesh> */}
            {/* @ts-ignore */}
