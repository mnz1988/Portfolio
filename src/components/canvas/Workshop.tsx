    ...
    return (
        ...
        <group {...props} dispose={null} scale={0.125} position={[0.22, -0.75, 0]}>
            ...
            <group>
                ...
                {/* @ts-ignore */}
                <mesh name="level2guards" geometry={nodes.level2guards.geometry} position={[18.296, 11.962, -12.788]} rotation={[0, 0, -Math.PI / 2]}><meshBasicMaterial map={bakedTexture} /></mesh>
                {/* Boxes on the Floor */}
                {/* @ts-ignore */}
