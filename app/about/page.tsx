      ...
      <div className="w-full grid grid-cols-12 overflow-y-auto" >
        ...
        <div className="w-full col-span-12 p-3 md:lg:xl:p-10 sm:col-span-7">
          ...
          <p className='my-2 py-3 leading-tight'>If I try to describe myself with words, I can say:<br></br>
            ...
            <br></br>When not working, I like to teaching people or try some inventions, be in nature, ride  a bicycle, climbing, listening to music and gettin caught in the rain.</p>
          <p></p>
        ...
        <div className="col-span-12 px-3 -mt-4 sm:px-35 md:px-35 lg:px-50 xl:px-60">
          ...
          <br></br>User Experience and Interface Design (UX/UI)
          <br></br>Visual Design
          <br></br>Product Managing...
          <p>I&apos;m a selflearner Designer. Also, I have a bachelors in electronics and master in IT</p>
          <p><a href='/moji_resume_design.pdf'>You can download my Resume here</a></p>
          Also, I work with this techs (software) and teach others too:
