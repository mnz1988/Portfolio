...
const About = dynamic(() => import('@/components/canvas/Examples').then((mod) => mod.About), { ssr: false })
    ...
    <>
      <div className="w-full grid grid-cols-12" >
        ...
        <div className="col-span-12 sm:col-span-4">
          <img src='/moji-as-monster.webp' loading="lazy" />
        </div>
        ...
        <div className="w-full col-span-12 px-3 md:lg:xl:px-10 py-3 md:lg:xl:py-10 sm:col-span-7">
          ...
          <p className='my-2 py-3 leading-tight'>If I try to describe myself with words, I can say:<br></br>
            <em>lifelong learner, </em>thinker, <em>reading,</em> designing, <em>editing,</em> creating, <em>imagening,</em> and playing around.
          ...
          <br></br><img className='rounded' src='/moji-desk.jpg' loading="lazy" />
          ...
          <div className="relative w-fit h-fit sm:mx-auto overflow-x-auto">
            ...
            <div className="mb-2 flex w-fit mx-auto gap-2">
              ...
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/3d/blender-2.svg" />
              </div>

              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/3d/rhino-logo.webp" />
              </div>

              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/3d/KeyShot-RGB.webp" />
              </div>

              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/3d/v-ray.svg" />
              </div>
            ...
            <div className="flex mb-2 w-fit mx-auto gap-1">
              <div className="border flex relative *:relative *: size-16 rounded-xl before:rounded-[11px] before:absolute before:inset-0 before:border-t ">
                <img src="/brands/adobe/after-effects-1.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 rounded-xl before:rounded-[11px] before:absolute before:inset-0 before:border-t ">
                <img src="/brands/adobe/adobe-photoshop-2.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 rounded-xl before:rounded-[11px] before:absolute before:inset-0 before:border-t ">
                <img src="/brands/adobe/adobe-indesign-cc-icon.svg" />
              </div>
            </div>

            <div className="flex w-fit mb-2 mx-auto gap-1">
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/web/react-2.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/web/threejs-1.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/web/bootstrap-5-1.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/web/nodejs-icon.svg" />
              </div>
            </div>

            <div className="flex w-fit mx-auto gap-1">
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/uiux/figma-5.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/uiux/adobe-xd-2.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/vector/adobe-illustrator-cc-icon.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/vector/inkscape-logo.svg" />
              </div>
            </div>

            <div className="mt-2 flex w-fit mx-auto gap-1">
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/general/github-seeklogo.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/general/office-2.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/general/trello_icon.svg" />
              </div>
            </div>

            <div className="my-2 flex w-fit mx-auto gap-1">
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/ai/ComfyUI.png" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/ai/bing-2.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/ai/openai-wordmark.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/ai/logo_white.webp" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-0 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/ai/A111.webp" />
              </div>
            </div>

            <div className="mt-2 flex w-fit mx-auto gap-1">
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/cms/wordpress-icon.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/cms/shopify.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/cms/drupal-4.svg" />
              </div>
            </div>

            <div className="mt-2 flex w-fit mx-auto gap-1">
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/crypto/bitcoin.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/crypto/ethereum-1.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/crypto/solana.svg" />
              </div>
              <div className="border flex relative *:relative *: size-16 p-2 rounded-xl dark:bg-gray-650 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-600 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-650">
                <img src="/brands/crypto/difi.svg" />
              </div>
            </div>
